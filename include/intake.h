...
public:
  ...
  Intake(
    vex::motor &conveyor, vex::motor &intake_roller, vex::motor &intake_ramp, vex::optical &conveyor_sensor,
    FilterColor filter_for
  )
      : conveyor(conveyor), intake_roller(intake_roller), intake_ramp(intake_ramp), conveyor_sensor(conveyor_sensor),
